...
class TanarFermier : public Fermier {
//	const int id;
//	static int nrFermieri;
// 
//	string nume;
...
//	int* pretEchipament;
	string studii;
	bool competenteInAgricultura;
	bool primesteSubventii;

public:
	TanarFermier() :Fermier() {
		this->studii = "Necunoscute";
		this->competenteInAgricultura = 0;
		this->primesteSubventii = 0;
	}

	TanarFermier(string nume, int varsta, int nrEchipamente, int* pretEchipament, string studii, bool competenteInAgricultura, bool primesteSubventii) :Fermier(nume, varsta, nrEchipamente, pretEchipament) {
		this->studii = studii;
		this->competenteInAgricultura = competenteInAgricultura;
		this->primesteSubventii = primesteSubventii;
	}

	TanarFermier(const TanarFermier &t) :Fermier(t) {
		this->studii = t.studii;
		this->competenteInAgricultura = t.competenteInAgricultura;
		this->primesteSubventii = t.primesteSubventii;
	}

	TanarFermier& operator=(const TanarFermier& t) {
		Fermier::operator=(t);
		this->studii = t.studii;
		this->competenteInAgricultura = t.competenteInAgricultura;
		this->primesteSubventii = t.primesteSubventii;
	...
	bool getCompetenteInAgricultura() {
		return this->competenteInAgricultura;
	}

	bool getPrimesteSubventii() {
		return this->primesteSubventii;
	}

	void setStudii(string studii) {
		this->studii = studii;
	}

	void setCompetenteInAgricultura(bool competenteInAgricultura) {
		this->competenteInAgricultura = competenteInAgricultura;
	}

	void setPrimesteSubventii(bool primesteSubventii) {
		this->primesteSubventii = primesteSubventii;
	}

	friend ostream& operator<<(ostream& out, const TanarFermier& t) {
		out << (Fermier&)t;
		out << "Studii: " << t.studii << endl;
		out << "Are competente in agricultura (0-NU, 1-DA): " << t.competenteInAgricultura << endl;
		out << "Primeste Subventii (0-NU, 1-DA): " << t.primesteSubventii << endl;
		return out;
	}
...
public:
	Rosie() :Leguma() {
		this->dimensiune = "Necunoscuta";
		this->pretVanzare = 0;
	}

	Rosie(const char* tipLeguma, float costKG, bool gataDeRecoltat, string dimensiune, float pretVanzare) :Leguma(tipLeguma, costKG, gataDeRecoltat) {
		this->dimensiune = dimensiune;
		this->pretVanzare = pretVanzare;
	}

	Rosie(const Rosie& r) :Leguma(r) {
		this->dimensiune = r.dimensiune;
		this->pretVanzare = r.pretVanzare;
	}

	Rosie& operator=(const Rosie& r) {
		Leguma::operator=(r);
		this->dimensiune = r.dimensiune;
		this->pretVanzare = r.pretVanzare;
		return *this;
	...
	void setPretVanzare(float pretVanzare) {
		this->pretVanzare = pretVanzare;
	}

	friend ostream& operator<<(ostream& out, const Rosie& r) {
		out << (Leguma&)r;
		out << "Dimensiune: " << r.dimensiune << endl;
		out << "Pret Vanzare: " << r.pretVanzare << endl;
		return out;
	}
...
void main() {
	...
	cout << "Tanar Fermier - relatie IS-A cu Fermier" << endl << endl;

	cout << "Constrcutor fara parametrii" << endl;
	TanarFermier t1;
	cout << t1 << endl << endl;

	cout << "Constructor cu toti parametrii" << endl;
	TanarFermier t2("Rares Istrate", 25, 2, pretEchipament, "Superioare", 1, 1);
	cout << t2 << endl << endl;
	...
	cout << "Afisam valorile t dupa modificari" << endl;
	t.setStudii("Medii");
	cout << "Studii: " << t.getStudii() << endl;
	t.setCompetenteInAgricultura(0);
	cout << "Are competente in agricultura (0-NU, 1-DA): " << t.getCompetenteInAgricultura() << endl;
	t.setPrimesteSubventii(0);
	cout << "Primeste Subventii (0-NU, 1-DA): " << t.getPrimesteSubventii() << endl << endl;
	cout << t << endl << endl;

	cout << "Up-casting" << endl;
	Fermier fUpCasting = t2;
	cout << fUpCasting << endl;
	cout << t2 << endl;
	...
	cout << "Rosie - relatie IS-A cu Leguma" << endl;
	...
	cout << "Constructor cu toti parametrii" << endl;
	Rosie r2("Rosie", 29.2, 1, "Cherry", 34.8);
	cout << r2 << endl << endl;
	...
	cout << "Afisam valorile r dupa modificari" << endl;
	r.setCostKG(6.85);
	cout << "Cost KG: " << r.getCostKG() << endl;
	r.setDimensiune("Mari");
	cout << "Dimensiune: " << r.getDimensiune() << endl;
	r.setPretVanzare(8.29);
	cout << "Pret vanzare: " << r.getPretVanzare() << endl << endl;
	cout << r << endl << endl;

	cout << "Up-casting" << endl;
	Leguma lUpCasting = r2;
	cout << lUpCasting << endl;
	cout << r2 << endl;

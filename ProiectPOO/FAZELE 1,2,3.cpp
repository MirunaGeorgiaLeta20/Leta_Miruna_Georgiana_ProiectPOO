...
public:
	...
	void afisareSera() {
		...
		if (tipSera != NULL && temperatura != NULL) {
			for (int i = 0; i < nrSere; i++) {
				cout << "Tip sera " << i + 1 << ": " << tipSera[i] << ", Temperatura " << i + 1 << ": " << temperatura[i] << endl;
			}
		}
		cout << endl;
	}
...
void main() {
	...
	cout << s3.getArePanouriFotovoltaice() << endl;

	s3.setJudet("Galati");
	cout <<"Judet: "<< Sera::getJudet() << endl << endl;

	cout << "Operatorul <<"<<"\nAfisare noua sera s3" << endl;
	cout << s3;
	cout << "Judet: " << Sera::getJudet();
	...
	cout << "Operator >=" << "\nComparam varstele fermierului f2 si f3" << endl;
	if (f2 >= f3) {
	...
	l2++;
	cout << "Operator++";
	cout <<"\nCreste costul/kg cu 1" << endl;
	l2.afisareLeguma();
	l3.afisareLeguma();
	cout << endl;

	cout << "Operator +" <<"\nCostul legumelor/kg"<< endl;
	Leguma l6 = l1+l2+l3;
	l6.afisareLeguma();
	cout << endl;
	...
	l3.setNrLegume(100);
	cout <<"Numar fermieri: "<<Leguma::getNrLegume() << endl << endl;

	cout << "Afisare noua leguma l3 " << endl;
	l3.afisareLeguma();
	cout << "Numar fermieri: " << Leguma::getNrLegume();
	cout << endl;
	cout << endl<<endl;


	cout << "Schimbam stadiul recoltarii" << endl;
	Leguma legume[] = { l1, l2, l3};
	for (int i = 0; i < 3; ++i) {
	...
	float costTotal = Leguma::calculCostTotal(legume, 3);
	cout << endl;
